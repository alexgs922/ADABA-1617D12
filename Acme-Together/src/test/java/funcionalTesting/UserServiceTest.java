...
public class UserServiceTest extends AbstractTest {
	...
	public void driver2() {
		...
		final Object testingData[][] = {
			{   //user 1 sigue a user 2 y decide dejar de seguirlo
				...
				"user2", 592, 593, IllegalArgumentException.class
			}, {
				...
				"user3", 591, 592, IllegalArgumentException.class
			}, {
	...
	protected void template3(final String username, final String adress, final Date birthDate, final String description, final String email, final String identefication, final String name, final String password, final String passwordCheck,
		final String phone, final String picture, final String surName, final String username1, final boolean termsOfUse, final Class<?> expected) {
		...
		try {
			...
			final RegistrationForm customerForm = new RegistrationForm();
			...
			final User user = this.userService.reconstruct(customerForm);
	...
	public void driver3() {
		...
		final Object testingData[][] = {
			{   //Usuario no registrado se registra en el sistema
				null, "adress", new Date(), "description", "email@gmail.com", "53585603L", "name", "123456", "123456", "+34955613568", "http://www.google.com", "surname", "usuarioPrueba", true, null
			}, {
				//Usuario no registrado se intenta registrar en el sistema con email invalido
				null, "adress", new Date(), "description", "email", "53585603L", "name", "123456", "123456", "+34955613568", "http://www.google.com", "surname", "usuarioPrueba", true, DataIntegrityViolationException.class
			}, {
				//Usuario no registrado se registra con un dni invalido
				null, "adress", new Date(), "description", "email@gmail.com", "535803", "name", "123456", "123456", "+34955613568", "http://www.google.com", "surname", "usuarioPrueba", true, DataIntegrityViolationException.class
			}, {
				//Usuario no registrado se registra con contraseñas diferentes
				null, "adress", new Date(), "description", "email@gmail.com", "535803", "name", "456789", "123456", "+34955613568", "http://www.google.com", "surname", "usuarioPrueba", true, DataIntegrityViolationException.class
			}, {
				//Usuario no registrado se registra en el sistema con campos null
				null, "adress", new Date(), null, null, "535803", "name", "123456", "123456", "+34955613568", null, "surname", "usuarioPrueba", true, DataIntegrityViolationException.class
			}, {
				//Usuario no registrado se registra en el sistema sin aceptar las condiciones de uso
				null, "adress", new Date(), "description", "email@gmail.com", "53585603L", "name", "123456", "123456", "+34955613568", "http://www.google.com", "surname", "usuarioPrueba", false, DataIntegrityViolationException.class

			}
		};

		for (int i = 0; i < testingData.length; i++)
			this.template3((String) testingData[i][0], (String) testingData[i][1], (Date) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (String) testingData[i][6], (String) testingData[i][7],
				(String) testingData[i][8], (String) testingData[i][9], (String) testingData[i][10], (String) testingData[i][11], (String) testingData[i][12], (boolean) testingData[i][13], (Class<?>) testingData[i][14]);
